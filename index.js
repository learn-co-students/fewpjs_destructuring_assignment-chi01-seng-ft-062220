...
const individualAnimals = farmAnimals.split(' ')
const [moo, neigh, baa, oink, cluck] = individualAnimals
const [Bessie, , Dolly, Babe, Little] = individualAnimals
const [black_and_white, , black, pink] = individualAnimals
